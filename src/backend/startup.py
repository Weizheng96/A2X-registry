...
def run_warmup() -> None:
    ...
    import logging
    from src.backend.services.search_service import (
        search_service, set_registry, discover_datasets, resolve_dataset_paths,
    )
    from src.backend.routers.dataset import init_registry_service
    from src.backend.routers.build import init_registry_service as init_build_service
