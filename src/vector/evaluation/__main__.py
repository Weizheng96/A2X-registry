"""CLI entry point: python -m src.vector.evaluation

Usage:
    python -m src.vector.evaluation --max-queries 50
    python -m src.vector.evaluation --service-path database/publicMCP/service.json \
...
from src.vector.evaluation.vector_evaluator import VectorEvaluator
