...
```bash
pip install "a2x-registry[full] @ git+https://github.com/Weizheng96/A2X-registry.git@v0.3.2"
```
...
> ```bash
> pip install "a2x-registry-client @ git+https://github.com/Weizheng96/A2X-registry.git@v0.3.2#subdirectory=client"
> ```
